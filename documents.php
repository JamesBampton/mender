...
<head>
	...
	<style>
		...
		.hide-id tr th:nth-child(-n+1),
		.hide-id tr td:nth-child(-n+1) {
			display: none;
		}
	</style>
...
<<body id="landingPage" data-spy="scroll" data-target=".navbar" data-offset="60">
	...
	<div>
		...
		<div class="content">
			...
			<div class="card">
				...
				<div class="details">
					<h2>
						...
						<br>
						<span>Application flow chart</span>
					</h2>
				</div>
			</div>
			...
			<div class="card">
				...
				<div class="details">
					<h2>
						<a href="cust-b.html" target="_blank">BOARDING PROCESS</a>
						<br>
			...
			<div class="card">
				...
				<div class="details">
					<h2>
						<a href="solution.html" target="_blank">PROCESS FLOW</a>
						<br>
	...
	<div class="container-carousel">
		...
		<p style="font-size: 14px;"><strong>ANT POWERED</strong></style>
		</p>
		<p style="font-size: 12px; color: orange;">Designed by James Bampton</style>
		</p>
		<br> <br>
